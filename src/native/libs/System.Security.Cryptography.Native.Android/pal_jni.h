...
// java/io/InputStream
extern jclass    g_InputStreamClass;
extern jmethodID g_InputStreamRead;
extern jmethodID g_InputStreamClose;
...
extern jmethodID g_HttpURLConnectionGetErrorStream;
extern jmethodID g_HttpURLConnectionGetInputStream;
